...
LOCAL_PATH := device/hardkernel/odroidq
...
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidq/vold.fstab:system/etc/vold.fstab
...
#-------------------------------------------------------------------------------------
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidq/drivers/bcmdhd.ko:system/lib/modules/bcmdhd.ko \
	device/hardkernel/odroidq/drivers/bcm4330.cal:system/etc/firmware/bcmdhd.cal \
	device/hardkernel/odroidq/drivers/bcm4330.hcd:system/etc/firmware/bcmdhd.hcd
...
# Init files
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidq/conf/init.odroidq.rc:root/init.odroidq.rc \
	device/hardkernel/odroidq/conf/init.odroidq.usb.rc:root/init.odroidq.usb.rc \

# For V4L2
ifeq ($(BOARD_USE_V4L2), true)
ifeq ($(BOARD_USE_V4L2_ION), true)
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidq/conf/ueventd.odroidq.v4l2ion.rc:root/ueventd.odroidq.rc
else
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidq/conf/ueventd.odroidq.v4l2.rc:root/ueventd.odroidq.rc
endif
else
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidq/conf/ueventd.odroidq.rc:root/ueventd.odroidq.rc
endif
